...
以下,1回目の交渉開始時に相手の提案を受諾する水準を\mathrm{L},交渉の時間経過に伴って水準\mathrm{L}に加算する値を\mathrm{\alpha},交渉回数の増加に伴って水準\mathrm{L}に加算する値を\mathrm{\beta}と定義する.
なお\mathrm{L}は相手から送信された提案における相手の推定効用の値である.
提案手法では相手の提案を受諾する水準を変化させる.1回の交渉ごとでは,時間経過に伴って水準を変化させる.
すなわち,図\ref{fig:propose}のように交渉開始時の水準が\mathrm{L}であった場合,時間経過によって水準を\mathrm{L\pm \alpha}に変化させる.以下,\mathrm{\alpha}を内側のパラメータ,\mathrm{\alpha}を使用する戦略を内側の戦略と記述する.
また,同時に交渉回数の増加に伴って水準を変化させる.
すなわち,図\ref{fig:propose}のように交渉開始時の水準が\mathrm{L}であった場合,2回目の交渉開始時の水準を\mathrm{L\pm \beta}に変化させる.以下,\mathrm{\beta}を外側のパラメータ,\mathrm{\beta}を使用する戦略を外側の戦略と記述する.
...
水準の変化にそれぞれ段階的要請法,譲歩的要請法,水準を変化させない方法の3種類を適用した9種類の戦略を提案する.
